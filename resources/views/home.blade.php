                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0">$ {{$revenueFinish}}  </span>
                    </div>
                    <div class="col-auto">
                      <div class="icon icon-shape bg-danger text-white rounded-circle shadow">
                        <i class="fas fa-chart-bar"></i>
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0">{{$NewOrderCount}} <i class='bx bxl-telegram' ></i></span>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-4  col-lg-4 col-md-6 col-sm-6">
              <div class="card card-stats mb-0 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Finished Order </h5>
                      <span class="h2 font-weight-bold mb-0">{{ $FinishedOrderCount }} <i class='bx bxl-telegram' ></i></span>
                    </div>
                    <div class="col-auto">
                      <div class="icon icon-shape bg-yellow text-white rounded-circle shadow">
                        <i class="fas fa-users"></i>
