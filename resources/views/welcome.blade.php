...
<nav class="navbar navbar-expand-lg menuBar">
  <div class="container-fluid">
    <a class="navbar-brand" href="#" style="font-weight:bold; font-size:2rem ;margin-left:20px;">Menu</a>
 </div>
</nav>
  ...
  <div class="container-fluid">
    <div class="row">
      @foreach ($listItems as $listItems)
        <div class="col-12 col-sm-12 col-md-6 col-lg-4 mt-3 list-item">
            <div class="card">
          ...
          <img class="menuImg" src="{{ asset('/img/' . $listItems->image) }}" alt="{{ $listItems->name }}" >
                    ...
                    <div class="card-body">
                        <h4 class="card-title">{{$listItems->name}}</h4>
                        <p class="card-text">{{$listItems->category}}</p>
                        <p class="card-text">${{$listItems->price}}</p>
<button class="" value="{{ $listItems->id }} - {{ $listItems->name }} - ${{ $listItems->price }}" data-bs-toggle="modal" data-bs-target="#modal-{{ $listItems->id }}" data-price="{{ $listItems->price }}">Click me</button>
...
<div class="modal fade" id="modal-{{$listItems->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
        <h5 class="modal-title" id="exampleModalLabel">Select the quantity of {{$listItems->name}}</h5>

        <br>
          <button class="myButton active" value="{{$listItems->id  . " - " . $listItems->name .  " - $" . $listItems->price}} " data-toggle="modal" data-target="#eachMenu" data-price="{{$listItems->price}}">Click me</button>
...
this.classList.add("active");
    ...
    input.addEventListener("change", function() {
      ...
      var modalBody = document.querySelector(".totalFood");
...
<i class='bx bxl-telegram' ></i> Order
</button>
</div>
<!-- Modal -->
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body totalFood">
...
<form class="form-class" action="{{route('update-occupancy', $variable)}}" method="post">
  ...
  <input type="hidden" name="totalPrice">
    <button type="submit" class="btn btn-primary"> <i class='bx bxl-telegram' ></i> Order Now</button>
    {{ csrf_field() }}
  </div>
</form>
